...
<html lang="en">
  <head>
    ...
    <title>Ajalatravel Signup</title>
    <!-- plugins:css -->
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="../../../../../../../ajalatravel/src/assets/css/demo_1/style.css">
    <!-- End Layout styles -->
    <link rel="shortcut icon" href="../../../../../../../ajalatravel/src/assets/images/favicon.png" />
  </head>
  <body>
            ...
            <div class="col-lg-4 mx-auto">
              ...
              <div class="auto-form-wrapper">
                <form action="#">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary submit-btn btn-block">Signup</button>
                  </div>
    ...
    <script src="../../../../../../../ajalatravel/src/assets/vendors/js/vendor.bundle.addons.js"></script>
    <!-- endinject -->
    <!-- inject:js -->
